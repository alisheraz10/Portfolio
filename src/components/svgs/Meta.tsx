const MetaLogo = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-0)"
    ...
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-1)"
      transform="translate(2 2)"
    ></path>
    <path
    ...
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-4)"
      transform="translate(2 2)"
    ></path>
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-5)"
      transform="translate(2 2)"
    ></path>
    <path
    ...
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-6)"
      transform="translate(2 2)"
    ></path>
    <path
    ...
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-7)"
      transform="translate(2 2)"
    ></path>
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-8)"
      transform="translate(2 2)"
    ></path>
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-9)"
      transform="translate(2 2)"
    ></path>
    <path
    ...
    <path
      ...
      fill="url(#lobe-icons-meta-brand-fill-12)"
      transform="translate(2 2)"
    ></path>
    <defs>
      <linearGradient
        id="lobe-icons-meta-brand-fill-0"
        x1="75.904%"
        x2="33.275%"
        y1="89.153%"
        y2="23.044%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-1"
        x1="21.67%"
        x2="97.068%"
        y1="75.837%"
        y2="24.022%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-2"
        x1="38.247%"
        x2="60.91%"
        y1="89.127%"
        y2="16.131%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-3"
        x1="47.027%"
        x2="52.153%"
        y1="90.19%"
        y2="15.745%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-4"
        x1="52.155%"
        x2="47.591%"
        y1="58.289%"
        y2="37.023%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-5"
        x1="37.689%"
        x2="61.961%"
        y1="12.556%"
        y2="63.605%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-6"
        x1="42.496%"
        x2="59.964%"
        y1="56.072%"
        y2="27.099%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-7"
        x1="43.753%"
        x2="57.613%"
        y1="6.235%"
        y2="98.514%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-8"
        x1="60.07%"
        x2="39.865%"
        y1="4.661%"
        y2="69.077%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-9"
        x1="30.254%"
        x2="61.097%"
        y1="59.32%"
        y2="33.244%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-10"
        x1="20.433%"
        x2="82.112%"
        y1="50.001%"
        y2="50.001%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-11"
        x1="40.289%"
        x2="72.427%"
        y1="35.298%"
        y2="57.811%"
      ...
      <linearGradient
        id="lobe-icons-meta-brand-fill-12"
        x1="32.228%"
        x2="68.028%"
        y1="19.719%"
        y2="84.908%"
